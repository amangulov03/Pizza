...
function PizzaBlock({
    ...
    const avilableTupes = ["тонкое", "традиционное"];
    ...
    const onAddPizza = () => {
        const obj = {
            ...
            imageUrl,
            price,
            size: avilableSizes[activeSizes],
            type: avilableTupes[activeType],
        };
        onClickAddPizza(obj);
    };
    ...
    return (
        <div className="pizza-block">
            ...
            <div className="pizza-block__bottom">
                <div className="pizza-block__price">от {price} cом</div>
